  ...
  loadMap(option) {
   // this.isLoadingMap = true;
    ...
    /* let mapData = [
       ...
       { 'id': 'AO', 'name': 'Angola', 'value': 19618432, 'color': am4core.color('#54cbf2'),  fill: am4core.color("#54cbf2") },
       { 'id': 'AR', 'name': 'Argentina', 'value': 40764561, 'color': am4core.color(color) ,  fill: am4core.color("#008ebc")},
       { 'id': 'AM', 'name': 'Armenia', 'value': 3100236, 'color': am4core.color('#007092'),  fill: am4core.color("#F05C5C") },
       { 'id': 'AU', 'name': 'Australia', 'value': 22605732, 'color': '#8aabb0',  fill: am4core.color("#008ebc") },
       { 'id': 'BH', 'name': 'Bahrain', 'value': 1323535, 'color': am4core.color('#008ebc'),  fill: am4core.color("#00ace3") },
       { 'id': 'BD', 'name': 'Bangladesh', 'value': 150493658, 'color': am4core.color('#00ace3'),  fill: am4core.color("#008ebc") },
       { 'id': 'BY', 'name': 'Belarus', 'value': 9559441, 'color': am4core.color('#00ace3'),  fill: am4core.color("#00ace3") },
       { 'id': 'BE', 'name': 'Belgium', 'value': 10754056, 'color': am4core.color('#00ace3'),  fill: am4core.color("#007092") },
       { 'id': 'BJ', 'name': 'Benin', 'value': 9099922, 'color': am4core.color('#008ebc'),  fill: am4core.color("#F05C5C") },
       { 'id': 'BO', 'name': 'Bolivia', 'value': 10088108, 'color': am4core.color('#54cbf2'),  fill: am4core.color("#007092") },
       { 'id': 'BW', 'name': 'Botswana', 'value': 2030738, 'color': am4core.color('#54cbf2'),  fill: am4core.color("#54cbf2") },
       { 'id': 'BR', 'name': 'Brazil', 'value': 196655014, 'color': am4core.color('#00ace3'),  fill: am4core.color("#008ebc") },
       { 'id': 'BN', 'name': 'Brunei', 'value': 405938, 'color': am4core.color('#008ebc'),  fill: am4core.color("#F05C5C") },
       { 'id': 'KH', 'name': 'Cambodia', 'value': 14305183, 'color': am4core.color('#008ebc'),  fill: am4core.color("#F05C5C") },
       { 'id': 'CM', 'name': 'Cameroon', 'value': 20030362, 'color': am4core.color('#54cbf2'),  fill: am4core.color("#008ebc") },
       { 'id': 'CA', 'name': 'Canada', 'value': 34349561, 'color': am4core.color('#00ace3'),  fill: am4core.color("#008ebc") }
     ];*/
    ...
    /* ends added zoom Control */

    /* slider starts */
    let slider = chartMap.createChild(am4core.Slider);
    ...
    // polygonTemplate.fill = chartMap.colors.getIndex(2).lighten(0.5);
    polygonTemplate.fill = am4core.color("#999999");
    ...
    /* polygonTemplate.adapter.add("fill", (fill, target)=> {
       ...
       if (target.dataItem.index > 0) {
         return chartMap.colors.getIndex(target.dataItem.index);
       }
       return fill;
     });*/
    /* random color generation ends */

    let hs = polygonTemplate.states.create("hover");
    hs.properties.fillOpacity = 1;
    hs.properties.fill = chartMap.colors.getIndex(7);
